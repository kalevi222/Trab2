...
namespace Estoque
{
    internal class Data
    {
        ...
        {
            string strconnection = "Data Source = DESKTOP-IF7IPKC\\MSSQLSERVER01; Initial Catalog = Estoque2; Integrated Security = True; Encrypt = True; Trust Server Certificate = True";
